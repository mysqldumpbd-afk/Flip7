...
function ScanModal({playerName,currentTotal,onResult,onClose,aiConfig,gameMode}){
  ...
  // Clasico vs. Venganza).
  var PROMPT_CLASSIC="Mira cuidadosamente la fotografia proporcionada. La imagen contiene cartas del juego Flip 7 -- version Clasica.\nTu objetivo es identificar TODAS las cartas visibles y legibles, clasificandolas correctamente en 3 categorias:\n\n1. CARTAS NUMERICAS\n2. CARTAS MODIFICADORAS\n3. CARTAS DE ACCION\n\nDebes ser CONSERVADOR con el reconocimiento: es mejor no contar una carta dudosa que inventar una carta que realmente no esta visible.\n\n1. CARTAS NUMERICAS\n\nLas cartas numericas tienen:\n* Fondo predominantemente blanco o crema.\n* Un numero grande como elemento principal.\n* Valores posibles exclusivamente del 0 al 12.\n* Cada numero tiene un color caracteristico.\n\nCOLORES DE REFERENCIA:\n0 = rosa/magenta brillante -- #FF2FA3\n1 = gris-lila -- #B7A9C9\n2 = amarillo-verde/lima -- #D8E81B\n3 = rojo-rosa -- #FF4B78\n4 = cyan/turquesa -- #19C7D8\n5 = verde -- #10C96C\n6 = morado/violeta -- #C86AE3\n7 = salmon/rosa palido -- #F48A9A\n8 = verde claro -- #9EDB92\n9 = naranja -- #FFA33A\n10 = rojo -- #FF3B3B\n11 = azul/celeste -- #6EBBFF\n12 = gris-lila -- #B9AEC9\n\nREGLAS PARA CARTAS NUMERICAS:\n* Prioriza siempre la forma del numero visible sobre el color.\n* El color funciona como una pista adicional para confirmar la identificacion.\n* Los colores pueden cambiar por iluminacion, sombras, reflejos, camara o balance de blancos. NO exijas coincidencia exacta con el HEX.\n* Una carta inclinada o rotada puede seguir siendo valida si el numero se distingue claramente.\n* Una carta parcialmente cubierta solamente debe contarse si existe suficiente informacion para identificar su numero con seguridad.\n* Puede haber varias cartas fisicas con el mismo numero. En ese caso, incluye el numero una vez por cada carta fisica que puedas distinguir claramente.\n* No inventes numeros que no puedas confirmar visualmente.\n\nATENCION ESPECIAL: 0 VS 10\nEl 0 y el 10 tienen colores DIFERENTES:\n0 = rosa/magenta brillante\n10 = rojo\nSi observas un numero rojo de DOS digitos, es un 10, no un 0.\nEl digito \"1\" del 10 puede verse delgado, borroso o estar parcialmente tapado por un dedo u otra carta.\nNO leas automaticamente un 10 parcialmente cubierto como 0.\nSi no puedes confirmar suficientemente ninguno de los dos valores, ignora esa carta.\n\nATENCION ESPECIAL: 1 VS 12\nEl 1 y el 12 utilizan tonos gris-lila muy similares.\nNo los diferencies solamente por color.\nBusca especificamente la presencia del segundo digito \"2\" para determinar si se trata de un 12.\n\nATENCION ESPECIAL: NUMERO 7\nEl 7 utiliza un color salmon/rosa muy palido que puede perderse contra el fondo blanco/crema.\nEs la carta numerica que requiere MAYOR ATENCION porque puede parecer una carta vacia o sin numero.\nAntes de decidir que una carta blanca/crema no tiene un numero visible, revisala especificamente buscando la silueta de un 7 rosa/salmon palido.\nNO inventes un 7. Esta regla solamente significa que debes hacer una revision adicional antes de descartarlo.\n\n2. CARTAS MODIFICADORAS\n\nLas cartas modificadoras tienen normalmente:\n* Fondo amarillo/dorado.\n* Marco o borde decorativo.\n* Un simbolo o valor grande en el centro.\n* Texto y simbolos predominantemente rojos, negros y crema.\n\nExisten unicamente estos 6 tipos:\nMULTIPLICADOR: x2\nCARTAS DE SUMA: +2, +4, +6, +8, +10\n\nREGLAS PARA MODIFICADORES:\n* Primero utiliza el fondo amarillo/dorado como pista para determinar si pertenece a esta categoria.\n* Despues identifica el simbolo central.\n* No confundas x2 con +2.\n* x2 utiliza el simbolo \"x\".\n* +2 utiliza el simbolo \"+\".\n* En +10 asegurate de reconocer ambos digitos: 1 y 0.\n* No asumas que existe un modificador por la puntuacion o por otras cartas presentes.\n* Solamente reporta un modificador si puedes ver fisicamente su carta.\n* Puede haber varias copias del mismo modificador. Solamente repitelo si puedes distinguir claramente dos cartas fisicas separadas.\n* No existen otros valores validos dentro de esta categoria aparte de x2, +2, +4, +6, +8 y +10.\n\n3. CARTAS DE ACCION\n\nLas cartas de accion son cartas ilustradas y visualmente diferentes de las cartas numericas y modificadoras.\nExisten unicamente 3:\n\nFREEZE\nCaracteristicas visuales: predomina azul/celeste, diseno relacionado visualmente con hielo/congelamiento, contiene la palabra \"FREEZE\".\n\nSECOND CHANCE\nCaracteristicas visuales: predomina rojo/rosa, presenta elementos graficos similares a corazones, contiene el texto \"SECOND CHANCE\". El nombre puede aparecer dividido visualmente en dos zonas.\n\nFLIP THREE\nCaracteristicas visuales: predomina amarillo, presenta ilustraciones de cartas y elementos graficos dinamicos, contiene el texto \"FLIP THREE\".\nIMPORTANTE: aunque Flip Three utiliza amarillo, NO debe confundirse con una carta modificadora. Las cartas modificadoras amarillas muestran claramente x2, +2, +4, +6, +8 o +10. Flip Three, en cambio, es una carta ilustrada que contiene el nombre de la accion.\n\nREGLAS PARA CARTAS DE ACCION:\n* Busca exclusivamente Freeze, Flip Three y Second Chance.\n* Utiliza una combinacion de texto, color, ilustraciones y diseno general.\n* No dependas exclusivamente de que el texto sea perfectamente legible si las demas caracteristicas permiten identificar claramente la carta.\n* Cuenta cada carta fisica por separado.\n* Si aparecen dos Freeze claramente separadas, debes registrar dos veces \"Freeze\".\n* NO elimines duplicados reales.\n* NO inventes duplicados.\n* Si solamente puedes confirmar una carta, cuenta una.\n\nCARTAS QUE DEBES IGNORAR\nIGNORA completamente:\n* Cartas boca abajo.\n* Cartas cuyo contenido no pueda reconocerse con suficiente claridad.\n* Cartas demasiado tapadas para determinar su identidad.\n* Objetos que parezcan cartas pero cuya identidad no pueda confirmarse.\n\nNO ADIVINES. Si dudas entre contar o no contar una carta, NO la cuentes.\n\nREGLAS DE CONTEO -- MUY IMPORTANTE\nCuenta cada carta FISICA visible una sola vez.\nNo repitas un numero, modificador o carta de accion a menos que puedas ver, con TOTAL certeza, dos o mas copias fisicas separadas de esa misma carta.\nAnte la duda entre ver 1 o 2 copias de la misma carta, responde 1.\nEs mejor SUBCONTAR que inventar una copia que no esta realmente visible.\nNo asumas que una carta esta presente debido a: las reglas del juego, la puntuacion esperada, otras cartas visibles, una combinacion logica, o la distribucion del mazo.\nIdentifica exclusivamente lo que esta fisicamente visible en la fotografia.\n\nDETECCION DE FLIP 7\nDespues de identificar todas las cartas numericas validas, determina cuantos VALORES NUMERICOS DISTINTOS existen.\nSi existen exactamente 7 valores numericos distintos: \"flip7\": true\nEn cualquier otro caso: \"flip7\": false\nIMPORTANTE: las cartas modificadoras NO cuentan para Flip 7, las cartas de accion NO cuentan para Flip 7, y las cartas numericas duplicadas NO aumentan la cantidad de valores distintos.\nEjemplo: [1,2,3,4,5,6,7] tiene 7 valores distintos -> flip7 = true.\nTambien: [1,2,3,4,5,6,6,7] tiene 7 valores distintos (1,2,3,4,5,6,7) -> flip7 = true.\nEl Flip 7 otorga un bonus de +15 puntos, pero NO agregues ese bonus como carta y NO modifiques los valores detectados.\n\nPROCEDIMIENTO DE REVISION OBLIGATORIO\nAntes de generar tu respuesta final:\n1. Recorre visualmente TODA la fotografia de izquierda a derecha y de arriba hacia abajo.\n2. Localiza primero cada CARTA FISICA visible.\n3. Ignora las cartas boca abajo o que no puedan reconocerse con suficiente claridad.\n4. Para cada carta valida, clasificala en UNA de estas categorias: NUMERICA, MODIFICADORA o ACCION.\n5. Si es NUMERICA, identifica un valor entre 0 y 12 utilizando principalmente la forma del numero y secundariamente su color.\n6. Si es MODIFICADORA, identifica exclusivamente: x2, +2, +4, +6, +8, +10.\n7. Si es de ACCION, identifica exclusivamente: Freeze, Flip Three, Second Chance.\n8. Comprueba que ninguna carta fisica haya sido contada dos veces.\n9. Realiza una revision especifica buscando posibles confusiones entre 0 y 10.\n10. Realiza una revision especifica buscando posibles confusiones entre 1 y 12.\n11. Realiza una segunda busqueda especifica de posibles cartas 7, debido a su bajo contraste.\n12. Verifica que cada modificador reportado corresponda a una carta fisicamente visible.\n13. Verifica individualmente cada aparicion de Freeze, Flip Three y Second Chance.\n14. Si parece haber varias copias de una misma carta, comprueba que realmente puedas distinguir varias cartas fisicas separadas.\n15. Ante cualquier duda entre una o varias copias, utiliza la cantidad MENOR que puedas confirmar.\n16. Calcula Flip 7 utilizando exclusivamente la cantidad de valores numericos distintos confirmados.\n\nFORMATO DE RESPUESTA OBLIGATORIO\nResponde UNICAMENTE con JSON valido.\nNO utilices Markdown.\nNO utilices bloques de codigo.\nNO escribas explicaciones antes del JSON.\nNO escribas explicaciones despues del JSON.\nUtiliza EXACTAMENTE esta estructura:\n{\"cards\":[<numeros enteros 0-12>],\"multiplier\":<2 si hay carta x2, si no null>,\"plus_cards\":[<subconjunto de 2,4,6,8,10 presentes>],\"action_cards\":[<nombres, uno por cada aparicion>],\"flip7\":<true si existen exactamente 7 valores numericos distintos, de lo contrario false>,\"note\":\"\"}\n\nRESTRICCIONES:\n\"cards\": solamente numeros enteros del 0 al 12; repite un numero unicamente si puedes confirmar varias cartas fisicas con ese mismo valor.\n\"multiplier\": solamente puede ser 2 o null; usa 2 unicamente si puedes ver fisicamente la carta x2.\n\"plus_cards\": solamente puede contener 2, 4, 6, 8 o 10; cada valor representa fisicamente +2, +4, +6, +8 o +10; no incluyas valores que no puedas confirmar visualmente; si no existe ninguna, utiliza [].\n\"action_cards\": solamente puede contener \"Freeze\", \"Flip Three\", \"Second Chance\"; incluye el nombre una vez por cada aparicion fisica confirmada; si no existe ninguna, utiliza [].\n\"flip7\": solamente true o false; es true unicamente cuando existen exactamente 7 VALORES NUMERICOS DISTINTOS confirmados.\n\"note\": escribe un resumen muy breve de lo identificado; puedes mencionar si ignoraste alguna carta por estar boca abajo, demasiado cubierta o ilegible; no inventes informacion.\n\nREGLA FINAL:\nPRECISION ANTES QUE CANTIDAD.\nSi una carta no puede identificarse con suficiente seguridad, IGNORALA.\nSi dudas entre una o dos copias, cuenta UNA.\nNunca completes cartas basandote en lo que \"deberia\" haber en una mano de Flip 7.\nReporta exclusivamente las cartas fisicas que realmente puedas confirmar en la fotografia.";
  var PROMPT_VENGANZA="Mira cuidadosamente la fotografia proporcionada. La imagen contiene cartas del juego Flip 7: With a Vengeance -- version Venganza.\nTu objetivo es identificar TODAS las cartas visibles y legibles, clasificandolas correctamente en 3 categorias:\n\n1. CARTAS NUMERICAS\n2. CARTAS MODIFICADORAS NEGATIVAS\n3. CARTAS DE ACCION\n\nDebes ser CONSERVADOR con el reconocimiento: es mejor no contar una carta dudosa que inventar una carta que realmente no esta visible.\n\n1. CARTAS NUMERICAS\n\nLas cartas numericas tienen:\n* Fondo predominantemente blanco o crema.\n* Un numero grande como elemento principal.\n* Valores posibles exclusivamente del 0 al 13.\n* Cada numero tiene un color caracteristico.\n\nCOLORES DE REFERENCIA:\n0 = rosa/magenta brillante -- #FF2FA3\n1 = gris -- #9C9096\n2 = amarillo-verde/lima -- #D9E026\n3 = rojo-rosa -- #C9466F\n4 = cyan/turquesa -- #44C1BB\n5 = verde -- #38B44A\n6 = morado/violeta -- #B9529F\n7 = salmon -- #D9837B\n8 = verde claro -- #B1D57A\n9 = naranja -- #F79420\n10 = rojo oscuro -- #BB2540\n11 = azul -- #6A8FC8\n12 = gris-cafe -- #9A8776\n13 = azul brillante -- #008CD3\n\nREGLAS PARA CARTAS NUMERICAS:\n* Prioriza siempre la forma del numero visible sobre el color.\n* El color funciona como una pista adicional para confirmar la identificacion.\n* Los colores pueden cambiar por iluminacion, sombras, reflejos, camara o balance de blancos. NO exijas coincidencia exacta con el HEX.\n* Una carta inclinada o rotada puede seguir siendo valida si el numero se distingue claramente.\n* Una carta parcialmente cubierta solamente debe contarse si existe suficiente informacion para identificar su numero con seguridad.\n* Puede haber varias cartas fisicas con el mismo numero. En ese caso, incluye el numero una vez por cada carta fisica que puedas distinguir claramente.\n* No inventes numeros que no puedas confirmar visualmente.\n\nATENCION ESPECIAL: 0 VS 10\nEl 0 y el 10 tienen colores DIFERENTES:\n0 = rosa/magenta brillante\n10 = rojo oscuro\nSi observas un numero rojo oscuro de DOS digitos, es un 10, no un 0.\nEl digito \"1\" del 10 puede verse delgado, borroso o estar parcialmente tapado por un dedo u otra carta.\nNO leas automaticamente un 10 parcialmente cubierto como 0.\nSi no puedes confirmar suficientemente ninguno de los dos valores, ignora esa carta.\n\nATENCION ESPECIAL: 11 VS 13\nEl 11 y el 13 utilizan tonos de azul parecidos.\nNo los diferencies solamente por color.\nBusca especificamente la presencia del segundo digito \"3\" para determinar si se trata de un 13.\n\nATENCION ESPECIAL: NUMERO 7\nEl 7 utiliza un color salmon que puede perderse contra el fondo blanco/crema.\nEs la carta numerica que requiere MAYOR ATENCION porque puede parecer una carta vacia o sin numero.\nAntes de decidir que una carta blanca/crema no tiene un numero visible, revisala especificamente buscando la silueta de un 7 salmon.\nNO inventes un 7. Esta regla solamente significa que debes hacer una revision adicional antes de descartarlo.\n\n2. CARTAS MODIFICADORAS NEGATIVAS\n\nLas cartas modificadoras tienen normalmente:\n* Fondo oscuro/rojo.\n* Marco o borde decorativo.\n* Un simbolo o valor grande en el centro.\n\nExisten unicamente estos 6 tipos:\nDIVISOR: /2\nCARTAS DE RESTA: -2, -4, -6, -8, -10\n\nREGLAS PARA MODIFICADORES:\n* Primero utiliza el fondo oscuro/rojo como pista para determinar si pertenece a esta categoria.\n* Despues identifica el simbolo central.\n* No confundas /2 con -2.\n* /2 utiliza el simbolo de division o una barra \"/\".\n* -2 utiliza el simbolo \"-\".\n* En -10 asegurate de reconocer ambos digitos: 1 y 0.\n* No asumas que existe un modificador por la puntuacion o por otras cartas presentes.\n* Solamente reporta un modificador si puedes ver fisicamente su carta.\n* Puede haber varias copias del mismo modificador. Solamente repitelo si puedes distinguir claramente dos cartas fisicas separadas.\n* No existen otros valores validos dentro de esta categoria aparte de /2, -2, -4, -6, -8 y -10.\n\n3. CARTAS DE ACCION\n\nLas cartas de accion son cartas ilustradas y visualmente diferentes de las cartas numericas y modificadoras.\nExisten unicamente 7: Just One More, Swap, Steal, Discard, Flip Four, Lucky 13, Unlucky 7. Cada una contiene su nombre como texto, con ilustraciones distintas entre si.\n\nREGLAS PARA CARTAS DE ACCION:\n* Busca exclusivamente esas 7 cartas.\n* Utiliza una combinacion de texto, color, ilustraciones y diseno general.\n* No dependas exclusivamente de que el texto sea perfectamente legible si las demas caracteristicas permiten identificar claramente la carta.\n* Cuenta cada carta fisica por separado.\n* Si aparecen dos copias de la misma carta claramente separadas, registrala dos veces.\n* NO elimines duplicados reales.\n* NO inventes duplicados.\n* Si solamente puedes confirmar una carta, cuenta una.\n\nCARTAS QUE DEBES IGNORAR\nIGNORA completamente:\n* Cartas boca abajo.\n* Cartas cuyo contenido no pueda reconocerse con suficiente claridad.\n* Cartas demasiado tapadas para determinar su identidad.\n* Objetos que parezcan cartas pero cuya identidad no pueda confirmarse.\n\nNO ADIVINES. Si dudas entre contar o no contar una carta, NO la cuentes.\n\nREGLAS DE CONTEO -- MUY IMPORTANTE\nCuenta cada carta FISICA visible una sola vez.\nNo repitas un numero, modificador o carta de accion a menos que puedas ver, con TOTAL certeza, dos o mas copias fisicas separadas de esa misma carta.\nAnte la duda entre ver 1 o 2 copias de la misma carta, responde 1.\nEs mejor SUBCONTAR que inventar una copia que no esta realmente visible.\nNo asumas que una carta esta presente debido a: las reglas del juego, la puntuacion esperada, otras cartas visibles, una combinacion logica, o la distribucion del mazo.\nIdentifica exclusivamente lo que esta fisicamente visible en la fotografia.\n\nDETECCION DE FLIP 7\nDespues de identificar todas las cartas numericas validas, determina cuantos VALORES NUMERICOS DISTINTOS existen.\nSi existen exactamente 7 valores numericos distintos: \"flip7\": true\nEn cualquier otro caso: \"flip7\": false\nIMPORTANTE: las cartas modificadoras NO cuentan para Flip 7, las cartas de accion NO cuentan para Flip 7, y las cartas numericas duplicadas NO aumentan la cantidad de valores distintos.\nEl Flip 7 otorga un bonus de +15 puntos, pero NO agregues ese bonus como carta y NO modifiques los valores detectados.\n\nPROCEDIMIENTO DE REVISION OBLIGATORIO\nAntes de generar tu respuesta final:\n1. Recorre visualmente TODA la fotografia de izquierda a derecha y de arriba hacia abajo.\n2. Localiza primero cada CARTA FISICA visible.\n3. Ignora las cartas boca abajo o que no puedan reconocerse con suficiente claridad.\n4. Para cada carta valida, clasificala en UNA de estas categorias: NUMERICA, MODIFICADORA o ACCION.\n5. Si es NUMERICA, identifica un valor entre 0 y 13 utilizando principalmente la forma del numero y secundariamente su color.\n6. Si es MODIFICADORA, identifica exclusivamente: /2, -2, -4, -6, -8, -10.\n7. Si es de ACCION, identifica exclusivamente: Just One More, Swap, Steal, Discard, Flip Four, Lucky 13, Unlucky 7.\n8. Comprueba que ninguna carta fisica haya sido contada dos veces.\n9. Realiza una revision especifica buscando posibles confusiones entre 0 y 10.\n10. Realiza una revision especifica buscando posibles confusiones entre 11 y 13.\n11. Realiza una segunda busqueda especifica de posibles cartas 7, debido a su bajo contraste.\n12. Verifica que cada modificador reportado corresponda a una carta fisicamente visible.\n13. Verifica individualmente cada aparicion de las cartas de accion.\n14. Si parece haber varias copias de una misma carta, comprueba que realmente puedas distinguir varias cartas fisicas separadas.\n15. Ante cualquier duda entre una o varias copias, utiliza la cantidad MENOR que puedas confirmar.\n16. Calcula Flip 7 utilizando exclusivamente la cantidad de valores numericos distintos confirmados.\n\nFORMATO DE RESPUESTA OBLIGATORIO\nResponde UNICAMENTE con JSON valido.\nNO utilices Markdown.\nNO utilices bloques de codigo.\nNO escribas explicaciones antes del JSON.\nNO escribas explicaciones despues del JSON.\nUtiliza EXACTAMENTE esta estructura:\n{\"cards\":[<numeros enteros 0-13>],\"divide\":<true si hay carta /2, si no false>,\"minus_cards\":[<subconjunto de 2,4,6,8,10 presentes, solo la magnitud>],\"action_cards\":[<nombres, uno por cada aparicion>],\"flip7\":<true si existen exactamente 7 valores numericos distintos, de lo contrario false>,\"note\":\"\"}\n\nRESTRICCIONES:\n\"cards\": solamente numeros enteros del 0 al 13; repite un numero unicamente si puedes confirmar varias cartas fisicas con ese mismo valor.\n\"divide\": solamente true o false; usa true unicamente si puedes ver fisicamente la carta /2.\n\"minus_cards\": solamente puede contener 2, 4, 6, 8 o 10 (la magnitud, sin signo); no incluyas valores que no puedas confirmar visualmente; si no existe ninguna, utiliza [].\n\"action_cards\": solamente puede contener \"Just One More\", \"Swap\", \"Steal\", \"Discard\", \"Flip Four\", \"Lucky 13\", \"Unlucky 7\"; incluye el nombre una vez por cada aparicion fisica confirmada; si no existe ninguna, utiliza [].\n\"flip7\": solamente true o false; es true unicamente cuando existen exactamente 7 VALORES NUMERICOS DISTINTOS confirmados.\n\"note\": escribe un resumen muy breve de lo identificado; puedes mencionar si ignoraste alguna carta por estar boca abajo, demasiado cubierta o ilegible; no inventes informacion.\n\nREGLA FINAL:\nPRECISION ANTES QUE CANTIDAD.\nSi una carta no puede identificarse con suficiente seguridad, IGNORALA.\nSi dudas entre una o dos copias, cuenta UNA.\nNunca completes cartas basandote en lo que \"deberia\" haber en una mano de Flip 7.\nReporta exclusivamente las cartas fisicas que realmente puedas confirmar en la fotografia.";
